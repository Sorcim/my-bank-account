...
const CategoryEditForm = ({category}) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route('category.patch', category.id), {
            onSuccess: () => {
                closeModal()
                displayNotification('category edited successfully', 'success', 'category')
            },
            onError: () => {
                displayNotification('An error occured while editing the category', 'error', 'category')
            }
        });
    };
