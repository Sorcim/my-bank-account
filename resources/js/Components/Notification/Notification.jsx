...
const Notification = () => {
    const {isDisplay, removeNotification, notificationType, notificationContent, notificationTitle} = useNotification()
                            ...
                            <div className="p-4">
                                <div className="flex items-start">
                                    <div className="shrink-0">
                                        ...
                                        <XMarkIcon aria-hidden="true" className="size-6 text-red-400" />}

                                    </div>
                                    <div className="ml-3 w-0 flex-1 pt-0.5">
                                        <p className="text-sm font-medium text-gray-900">{notificationTitle}</p>
                                        <p className="mt-1 text-sm text-gray-500">{notificationContent}</p>
                                    </div>
